...
enum TYPE_QUESTION {
    case GOTOWEB, TRAINER
}

@objc public protocol KYPromptsProtocol
{
...
public class KYPromptsView: UIView
{
    //Delegate var
    public var delegate : KYPromptsProtocol?
    
    var isActive = false
    var isQuestion = false
    var typeQuestion : TYPE_QUESTION = TYPE_QUESTION.TRAINER
    ...
    override public func drawRect(rect: CGRect)
    {
        ...
        //let promptSize = CGRect(x: 0, y: 0, width: promptWidth, height: promptHeight)
        ...
        if (promptDismissIconVisibility)
        {
            ...
            //let dismissButton   = UIButton(type:UIButtonType.System) as UIButton
    ...
    internal func rotated(notification: NSNotification) {
        ...
        {
            print("Portrait", appendNewline: false)
        }
    }
    ...
    func updatePrompt(newPrompt: KYPromptsView){
        self.fadeOut()
        self.addSubview(newPrompt)
        self.fadeIn()
    }
    ...
    {
        //Mater Class
        let masterClass : KYPromptsView
        
        //Gesture Recognizer Vars
        var lastLocation:CGPoint = CGPointMake(0, 0)
        
        init(master: KYPromptsView)
        {
