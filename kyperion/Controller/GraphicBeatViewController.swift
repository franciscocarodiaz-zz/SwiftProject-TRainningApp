//
//  GraphicBeatViewController.swift
//  kyperion
//
...
class GraphicBeatViewController: UIViewController, APChartViewDelegate, UITableViewDataSource,UITableViewDelegate {
    ...
    func createLine(){
        ...
        var velocityPoints = currentActivity.avgHeartRateArrayLapsSorted()
