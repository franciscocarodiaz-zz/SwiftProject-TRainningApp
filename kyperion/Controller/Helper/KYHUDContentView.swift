...
@objc public class KYHUDSquareBaseView: UIView {
...
@objc public class KYHUDWideBaseView: UIView {
...
@objc public class KYHUDTextView: KYHUDWideBaseView {
...
@objc public class KYHUDImageView: KYHUDSquareBaseView {
...
@objc public final class KYHUDProgressView: KYHUDImageView {
    public init() {
    ...
    private override func commonInit(image: UIImage?) {
        ...
        let progressImage = AssetsManager.progressImage
...
@objc public final class KYHUDSystemActivityIndicatorView: UIView {
...
@objc public final class KYHUDTitleView: KYHUDImageView {
...
@objc public final class KYHUDSubtitleView2: KYHUDImageView {
...
@objc public final class KYHUDSubtitleView: KYHUDImageView {
    ...
    public override func layoutSubviews() {
        ...
        activity.frame = CGRect(origin: CGPoint(x: 0.0, y: opticalOffset), size: CGSize(width: viewWidth, height: threeQuarterHeight - opticalOffset))
...
@objc public final class KYHUDStatusView: KYHUDImageView {
